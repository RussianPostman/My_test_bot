...
HELLO_TEXT = (
    ...
    + '\n'
    + ' - Обращаю внимание, что все мои функции рассчитаны только на ввод '
    + 'команд через клавиатуру. Попытка ввода самостоятельно, скорее всего, ни к чему'
    + ' не приведёт.\n'
    + 'Если вдруг у Вас пропала клавиатура, обратите внимание на кнопку выбора смайликов '
    + 'и эмодзи. Слева от неё есть квадрат с четырьмя точками внутри, '
    + 'это и есть кнопка открытия кнопочного интерфейса бота.\n'
    + '\n'
    + ' - Чтобы получить быстрый обзор свободного времени, нажмите кнопку '
    + '"Расписание" \n'
    + '\n'
    + ' - Чтобы забронировать время, перейдите в раздел "Мои_бронирования", '
    + 'при помощи соответствующей кнопки, '
    + 'после чего нажмите "Забронировать время" и '
    + 'следуйте подсказкам в интерфейсе.\n'
    + '\n'
    + ' - В любой момент вы можете отменить бронирование нажав '
    + '"Отменить_бронирование" в разделе "Мои_бронирования"\n'
    + '\n'
